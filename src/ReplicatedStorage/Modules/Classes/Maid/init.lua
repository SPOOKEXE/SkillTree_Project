...
local validTypeTask : Func = function(self : table, _task : any) : boolean
	if _task == self then
		return false
	end
	return
...
function Maid:Give(_task : any) : nil
...
function Maid:Cleanup() : nil
	for _ : number, _task : any in ipairs(self._tasks) do
...
function Maid:__tostring() : string
	local taskStrings : table = { }
	for _ : number, _task : any in ipairs(self._tasks) do
...
function Maid:__newindex(t : any, index : any, value : any) : nil
